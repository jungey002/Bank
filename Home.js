...
<p>Learning</p>
  ...
  <a href="https://www.apple.com/app-store/" className="btn btn-dark d-inline-flex align-items-center" style={{ borderRadius: '10px', padding: '10px 20px' }}>
    <img
  ...
  <a href="https://play.google.com/store" className="btn btn-dark d-inline-flex align-items-center ml-4" style={{ borderRadius: '10px', padding: '10px 20px' }}> {/* Changed ml-3 to ml-4 */}
    <img
